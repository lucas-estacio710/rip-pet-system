...
import {
  Flame, Search, X, ChevronRight, Dog, Cat, Bug, MapPin,
  ...
  return (
    <div className="animate-fade-in">
      ...
      {loading ? (
        ...
        <EmptyState icon={Flame} title="Nenhum pet na matriz" description="Quando as unidades enviarem pets para cremação, eles aparecerão aqui." />
      ) : (
