      ...
      {editando && (
        <IndicacaoModal
          contrato={{
            ...
            pet_nome: editando.pet_nome,
            estabelecimento_indicacao_id: editando.estabelecimento_indicacao_id,
            contato_id: editando.contato_id,
            indicacao_clinica: editando.indicacao_clinica,
            indicacao_contato: editando.indicacao_contato,
          }}
          onClose={() => setEditando(null)}
          onSuccess={() => { setEditando(null); carregar() }}
        />
      )}
    </div>
  )
